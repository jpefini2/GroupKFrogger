...
{
    /// <summary>
    /// The settings for a game of Frogger
    /// </summary>
    /// <seealso>
    ...
    {
        /// <summary>
        /// Gets the number of starting lives.
        /// </summary>
        /// <value>
        ...
        {
            var level1LaneSettings = new List<LaneSettings> {
            ...
            var level2LaneSettings = new List<LaneSettings> {
            ...
            var level3LaneSettings = new List<LaneSettings> {
